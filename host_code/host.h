...
int pdma_write_all(unsigned char* buffer_addr, int buffer_length, int index);
int pdma_read_all(int socket_fd, unsigned char* buffer_addr, int buffer_length, int index);
